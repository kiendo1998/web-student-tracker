 ...
 */
@WebServlet("/ScoreTableControllerServletReport")
public class ScoreTableControllerServletReport extends HttpServlet {
...
//			    break;
	...
	private void searchScoretables(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("ScoretableReportManage/list-scoretables.jsp");
...
//		Score theScore = scoretableDbUtil.getScoretable(theScoreId);
				...
				//send to jsp page (view)
				RequestDispatcher dispatcher = request.getRequestDispatcher("/ScoretableReportManage/list-scores.jsp");
				dispatcher.forward(request, response);
			}
